...
8. 在“我的行程 → 管理行程 → 公开分享行程”填写最多 500 字的介绍，检查预览并发布，获得唯一分享口令。市场展示作者昵称和圆形头像，介绍在卡片中显示一行、预览中展示全文。创建者可以更新或取消分享；私人修改不会自动公开。在“我的行程 → 行程市场”通过分享口令、目的地或名称搜索、预览公开安排，登录后选择出发日期并复制为独立行程。资料、成员、账本、电话、预订编号、备注和准备清单不会公开或复制，原行程的后续修改也不会影响副本。
